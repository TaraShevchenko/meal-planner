...
- [ ] **Настройка Neon PostgreSQL для продакшена**
  - [ ] Создание проекта в Neon
  - [ ] Обновление DATABASE_URL на Neon connection string
  - [ ] Удаление Supabase зависимостей и конфигурации
  - [ ] **Миграция базы данных на Neon**
    - [ ] Применение Prisma схемы к Neon БД
    - [ ] Тестирование подключения через Prisma
    - [ ] Проверка работы tRPC с новой БД
    - [ ] Тестирование в разных окружениях
  - [ ] **Интеграция пользователей Clerk с Prisma**
    - [ ] Обновление модели User в Prisma схеме
    - [ ] Middleware для синхронизации пользователей
    - [ ] Webhook для обновления профилей
    - [ ] Тестирование создания/обновления профилей
